    ...
    <div class="container-fluid" id="therapists-container">
        ...
        <div id="boxes" class="mr-t"> 
            ...
            if (!empty($_REQUEST['lsearch'])) {
                                        ...
                                        <div id="info">
                                            <div class="name-desig-img">
                                                <div class="name-desig">          
                                                    <a class="therapist-name1" href="profile.php">';echo $field2name;echo'</a>
                ...
                $query = "SELECT * FROM `therapists` AS `T` inner join `personal details` as `P` ON `T`.`Therapist ID` = `P`.`Therapist ID`";
