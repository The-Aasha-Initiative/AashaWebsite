...
<?php
   ...
   session_start();
    ...
    $loc = $_SESSION['location'];
        ...
        if(empty($state2) and empty($state3) and empty($state4) and empty($state5) and !empty($state1))
        {
        ...
        else if(empty($state1) and empty($state3) and empty($state4) and empty($state5) and !empty($state2))
        {
        ...
        else if(empty($state1) and empty($state2) and empty($state4) and empty($state5) and !empty($state3))
        {
        ...
        else if(empty($state1) and empty($state2) and empty($state3) and empty($state5) and !empty($state4))
        {
        ...
        else if(empty($state1) and empty($state2) and empty($state4) and empty($state3) and !empty($state5))
        {
        ...
        else if(empty($state3) and empty($state4) and empty($state5) and !empty($state1) and !empty($state2))
        {
        ...
        else if(empty($state2) and empty($state4) and empty($state5) and !empty($state1) and !empty($state3))
        {
        ...
        else if(empty($state2) and empty($state3) and empty($state5) and !empty($state4) and !empty($state1))
        {
        ...
        else if(empty($state2) and empty($state3) and empty($state4) and !empty($state1) and !empty($state5))
        {
        ...
        else if(empty($state1) and empty($state4) and empty($state5) and !empty($state2) and !empty($state3))
        {
        ...
        else if(empty($state1) and empty($state3) and empty($state5) and !empty($state4) and !empty($state2))
        {
        ...
        else if(empty($state1) and empty($state3) and empty($state4) and !empty($state2) and !empty($state5))
        {
        ...
        else if(empty($state1) and empty($state2) and empty($state5) and !empty($state4) and !empty($state3))
        {
        ...
        else if(empty($state1) and empty($state2) and empty($state3) and !empty($state4) and !empty($state5))
        {
        ...
        {
            $find="SELECT * FROM `therapists` AS `T` inner join `personal details` as `P` ON `T`.`Therapist ID` = `P`.`Therapist ID` WHERE `Location` LIKE '%".$loc."%' AND `Languages` LIKE '%".$state5."%' AND `Client Group` LIKE '%".$state3."%' AND `Issues Treated` LIKE '%".$state4."%' AND `Designation` LIKE '%".$state1."%'";
            if ($result = $mysqli->query($find)) {
        ...
        {
            $find="SELECT * FROM `therapists` AS `T` inner join `personal details` as `P` ON `T`.`Therapist ID` = `P`.`Therapist ID` WHERE `Location` LIKE '%".$loc."%' AND `Issues Treated As` LIKE '%".$state4."%' AND `Client Group` LIKE '%".$state3."%' AND `Designation` LIKE '%".$state1."%' ";
            if ($result = $mysqli->query($find)) {
